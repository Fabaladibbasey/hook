...
public class ProviderAvailabilityOptions
{
    ...
    // After this elapses without an AdvanceRegistrationDraft callback, RegistrationOrchestrator
    // force-reverts a ResolvingServices draft so the user is not trapped if the LLM dead-lettered
