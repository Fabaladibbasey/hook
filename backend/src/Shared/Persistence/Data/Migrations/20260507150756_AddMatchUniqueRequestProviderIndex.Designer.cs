...
namespace Hook.Shared.Persistence.Data.Migrations
{
    ...
    [Migration("20260507150756_AddMatchUniqueRequestProviderIndex")]
    partial class AddMatchUniqueRequestProviderIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hook.Features.ChatSession.ParticipantAggregate.ChatDeviceKey", b =>
                {
                    ...
                    b.HasIndex("ChatId")
                        .HasDatabaseName("ix_chat_device_keys_chat");

                    b.HasIndex("ParticipantId", "DeviceId")
                        .IsUnique()
                        .HasDatabaseName("ux_chat_device_keys_participant_device");

                    b.ToTable("chat_device_keys", (string)null);
                });
            ...
            modelBuilder.Entity("Hook.Features.ChatSession.SessionAggregate.ChatMessageRecipient", b =>
                {
                    ...
                    b.HasKey("MessageId", "RecipientDeviceId");

                    b.HasIndex("RecipientDeviceId")
                        .HasDatabaseName("ix_chat_message_recipients_device");

                    b.ToTable("chat_message_recipients", (string)null);
                });
