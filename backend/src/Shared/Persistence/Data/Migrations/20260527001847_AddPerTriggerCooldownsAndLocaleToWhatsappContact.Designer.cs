...
namespace Hook.Shared.Persistence.Data.Migrations
{
    ...
    [Migration("20260527001847_AddPerTriggerCooldownsAndLocaleToWhatsappContact")]
    partial class AddPerTriggerCooldownsAndLocaleToWhatsappContact
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hook.Features.MetaTemplates.WhatsappContact", b =>
                {
                    ...
                    b.Property<string>("TipCooldowns")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
