...
public class RouteMatchToChatHandlerTests
{
    ...
    public RouteMatchToChatHandlerTests()
    {
    ...
    private RouteMatchToChatHandler Build()
    {
        var factory = new ChatSessionFactory(_chatsMock.Object, _chatOptions, _clock);
        return new RouteMatchToChatHandler(factory, _matchesMock.Object,
            NullLogger<RouteMatchToChatHandler>.Instance);
    }
    ...
    private static RouteMatchToChatCommand MakeEvt(
        Guid matchId,
