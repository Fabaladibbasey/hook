...
- `.github/workflows/ci.yml` — restore, Release build, tests, smoke container publish. `working-directory` = `backend/`. Runner: Ubuntu. Postgres service: `postgis/postgis:16-3.4`.
